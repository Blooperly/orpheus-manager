...
{
    public partial class ManageSkillsFirst : Form
    {
        public ManageSkillsFirst()
        {
            InitializeComponent();
        }
        ...
        private void skillCheck2()
        {
            ...
            reportAlt2.Text = "Combat Skills: " + temp2 + " Levels\nNon-Combat Skills: " + temp + " Levels";
        }
        ...
        private void SR2_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR3_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR4_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR5_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR6_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR7_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR8_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR9_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR10_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR11_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR12_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR13_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR14_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR15_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR16_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR17_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR18_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void SR19_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR0_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }
        ...
        private void NR3_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR4_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR5_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR6_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR7_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR8_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR9_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR10_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR11_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR12_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR13_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR14_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR15_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR16_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR17_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR18_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }

        private void NR19_TextChanged(object sender, EventArgs e)
        {
            skillCheck2();
        }
    }
