...
namespace OrpheusManager
{
    ...
    {
        public static string version = "v1.2";                                          // Orpheus Manager Version
        ...
        public static int cPortrait = 0;                                                // Character Portrait (0 = Default)
    ...
    public static class SDATA
    {
        ...
        public static void generateFile(string filepath)
        {
            ...
            if (CDATA.version == "v1.0") fileVersionDouble = 1.0;
            else if (CDATA.version == "v1.1") fileVersionDouble = 1.1;
            else if (CDATA.version == "v1.2") fileVersionDouble = 1.2;
            ...
            using (FileStream fs = File.Create(filepath))
            {
                ...
                {
                    saveString += "Character Portrait:\r\n";
                    saveString += CDATA.cPortrait + "\r\n\r\n";
                }
